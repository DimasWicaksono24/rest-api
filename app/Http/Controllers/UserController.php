...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($response->failed()) {
            ...
            return redirect()->back()->with('error','Gagal bre');
        }
        ...
        return redirect()->route('users.index')->with('success','Berhasil bre');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($response->failed()) {
            ...
            return redirect()->route('users.index')->with('error','Gagal Bre');
        }
        return redirect()->back()->with('success','Berhasil Bre');
    }
